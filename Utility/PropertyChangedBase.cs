...
namespace Schala
{
    ...
    public class ObservableBackgroundService : BackgroundService, INotifyPropertyChanged
    {
        #region Implement INotifyPropertyChanged
        public event PropertyChangedEventHandler? PropertyChanged;
        ...
        private readonly ILogger<SchalaClient> _logger;

        public ObservableBackgroundService(ILogger<SchalaClient> logger)
        {
            _logger = logger;
        }
