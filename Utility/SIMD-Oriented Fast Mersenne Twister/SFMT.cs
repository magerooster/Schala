...
namespace Rei.Random
{
    ...
    public class SFMT : RandomBase
    {
        ...
        /// <summary>
        /// MT‚ÌŽüŠú‚ð•ÛØ‚·‚é‚½‚ß‚ÌŠm”F‚É—p‚¢‚éƒpƒ‰ƒ[ƒ^[‚Ìˆê‚ÂB
        /// </summary>
        ...
        /// <summary>
        /// Še—v‘f‚ð128bit‚Æ‚µ‚½‚Æ‚«‚Ì“à•”ó‘ÔƒxƒNƒgƒ‹‚ÌŒÂ”B
        /// </summary>
        protected int N;
        /// <summary>
        /// Še—v‘f‚ð32bit‚Æ‚µ‚½‚Æ‚«‚Ì“à•”ó‘ÔƒxƒNƒgƒ‹‚ÌŒÂ”B
        /// </summary>
        protected int N32;
        /// <summary>
        /// ŒvŽZ‚Ì‚‘¬‰»—pB
        ...
        /// <summary>
        /// “à•”ó‘ÔƒxƒNƒgƒ‹‚Ì‚¤‚¿AŽŸ‚É—”‚Æ‚µ‚ÄŽg—p‚·‚éƒCƒ“ƒfƒbƒNƒXB
        /// </summary>
        protected int idx;
        ...
        /// <summary>
        /// Œ»ÝŽž‚ðŽí‚Æ‚µ‚½A(2^19937-1)ŽüŠú‚ÌSFMT‹[Ž——”ƒWƒFƒlƒŒ[ƒ^[‚ð‰Šú‰»‚µ‚Ü‚·B
        /// </summary>
        public SFMT() : this(Environment.TickCount, 19937) { }

        /// <summary>
        /// seed‚ðŽí‚Æ‚µ‚½A(2^19937-1)ŽüŠú‚Ì‹[Ž——”ƒWƒFƒlƒŒ[ƒ^[‚ð‰Šú‰»‚µ‚Ü‚·B
        /// </summary>
        public SFMT(int seed) : this(seed, 19937) { }

        /// <summary>
        /// seed‚ðŽí‚Æ‚µ‚½Aperiod‚Å•\‚³‚ê‚éŽüŠú‚Ì‹[Ž——”ƒWƒFƒlƒŒ[ƒ^[‚ð‰Šú‰»‚µ‚Ü‚·B
        /// </summary>
        public SFMT(int seed, MTPeriodType period) : this(seed, (int)period) { }

        /// <summary>
        /// seed‚ðŽí‚Æ‚µ‚½A(2^mexp-1)ŽüŠú‚Ì‹[Ž——”ƒWƒFƒlƒŒ[ƒ^[‚ð‰Šú‰»‚µ‚Ü‚·B
        /// mexp‚Í607,1279,2281,4253,11213,19937,44497,86243,132049,216091‚Ì‚¢‚¸‚ê‚©‚Å‚ ‚é•K—v‚ª‚ ‚è‚Ü‚·B
        /// </summary>
        ...
        /// <summary>
        /// “à•”ó‘ÔƒxƒNƒgƒ‹‚ª“KØ‚©Šm”F‚µA•K—v‚Å‚ ‚ê‚Î’²ß‚µ‚Ü‚·B
        /// </summary>
        ...
        /// <summary>
        /// gen_rand_all‚Ì(2^19937-1)ŽüŠú—pB
        /// </summary>
        ...
        public SFMT CopyCurrentState()
        {
            SFMT newInstance = new SFMT()
            {
                MEXP = this.MEXP,
                POS1 = this.POS1,
                SL1 = this.SL1,
                ...
                MSK3 = this.MSK3,
                MSK4 = this.MSK4,
                PARITY1 = this.PARITY1,
                PARITY2 = this.PARITY2,
                PARITY3 = this.PARITY3,
                PARITY4 = this.PARITY4,
                N = this.N,
                N32 = this.N32,
                SL2_x8 = this.SL2_x8,
                SR2_x8 = this.SR2_x8,
                SL2_ix8 = this.SL2_ix8,
                SR2_ix8 = this.SR2_ix8,
                sfmt = (UInt32[])sfmt.Clone(),
                idx = this.idx,
            };
    ...
    /// <summary>
    /// ƒƒ‹ƒZƒ“ƒkƒcƒCƒXƒ^[‚Å—p‚¢‚éŽüŠú‚ð‚ ‚ç‚í‚·—ñ‹“Œ^B
    /// </summary>
    public enum MTPeriodType
    {
        ...
        MT86243 = 86243,
        /// <summary>
        /// 2^132049-1ŽüŠú‚ÌMTB
        /// </summary>
        MT132049 = 132049,
        /// <summary>
        /// 2^216091-1ŽüŠú‚ÌMTB
        /// </summary>
        MT216091 = 216091
    }
