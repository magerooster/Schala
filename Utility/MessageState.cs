...
namespace Schala
{
    ...
    {
        protected StringBuilder HeaderText = new StringBuilder();
        protected StringBuilder BlockQuoteText = new StringBuilder();
        ...
        public virtual async Task StartResponseAsync(bool Ephermeral)
        {
            await Task.Delay(0);
        }

        public virtual async Task FinishResponseAsync(string Message)
        {
            await Task.Delay(0);
        }
        #endregion 
