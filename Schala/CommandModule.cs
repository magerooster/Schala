...
namespace Schala
{
    ...
    {
        private static readonly (DiscordPermission Permission, string Label)[] TrackedPermissions = new[]
        {
        ...
        [Command("permissions")]
        public async Task CheckPermissions(CommandContext ctx, DiscordMember User, DiscordChannel Channel)
        {
